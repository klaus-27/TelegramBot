...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝙼𝙾𝚅𝙸𝙴 𝙶𝚛𝚘𝚞𝚙🎥', url='https://t.me/sai_movies27'),
            InlineKeyboardButton('𝙾𝚠𝚗𝚎𝚛👤', url='https://t.me/sai_nishchai27')
            ],[      
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ɴᴇxᴛ', callback_data='𝓚𝓵𝓪𝓾𝓼')    
        ], [
        ...
        buttons = [[
             ...
             InlineKeyboardButton('ʙᴀᴄᴋ👈', callback_data='𝓚𝓵𝓪𝓾𝓼'),
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://github.com/Sainishchai/TelegramBot'),
        ...
        buttons = [[
            InlineKeyboardButton('ʙᴀᴄᴋ👈', callback_data='nishu')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://github.com/Sainishchai/Doctor-Strange'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/sai_nishchai27')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ👈', callback_data='𝓚𝓵𝓪𝓾𝓼')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
